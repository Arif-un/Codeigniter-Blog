                    ...
                    <div class="dropdown is-right">
                            ...
                            <div class="dropdown-menu" id="dropdown-menu" role="menu">
                                <div class="dropdown-content">
                                    <a id="publish" class="dropdown-item">
                                        Publish Now<i class="is-pulled-right ti-upload"></i>
                                    </a>
                                    <a href="#" class="dropdown-item">
                                        Save for later <i class="is-pulled-right ti-save-alt"></i>
                                    </a>
        ...
        <section id="section" class="wrapper">
            <div style="margin-top: 56px;">
                ...
                <div class="write-content">
                    <textarea id="content-title" placeholder="Post Title"></textarea>
                    <textarea id="content-subtitle" placeholder="Sub-Title"></textarea>
                    <div id="content" ></div>
                    <br>
                </div>
